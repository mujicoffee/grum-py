let console = (function (oldConsole) {
    return {
        formatArgsOutput: function(arg) {
            ...
            return outputArgMessage; // Return the formatted message
        },
        ...
        logMultileArguments: function(arguments){
            let currentLog = "";
        ...
        log: function (text) {
            ...
            return argsArray.length != 1 ? this.logMultileArguments(argsArray) : 
